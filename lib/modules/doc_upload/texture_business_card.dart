...
class TextureBusinessCard extends StatefulWidget {
  const TextureBusinessCard({Key? key}) : super(key: key);

  @override
  State<TextureBusinessCard> createState() => _TextureBusinessCardState();
}

class _TextureBusinessCardState extends State<TextureBusinessCard> {
  @override
                    ...
                    child: ListView(
                      children: [
                        Container(
                            ...
                            child: Text('Texture Business Card',style: headTxtStyleW,)),
